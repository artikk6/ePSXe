...
public class AESObfuscator implements Obfuscator {
    ...
    /* renamed from: IV */
    private static final byte[] f216IV = {16, 74, 71, -80, 32, 101, -47, 72, 117, -14, 0, -29, 70, 65, -12, 74};
    ...
    public AESObfuscator(byte[] salt, String applicationId, String deviceId) {
        try {
            ...
            this.mEncryptor.init(1, secret, new IvParameterSpec(f216IV));
            this.mDecryptor = Cipher.getInstance(CIPHER_ALGORITHM);
            this.mDecryptor.init(2, secret, new IvParameterSpec(f216IV));
