...
public class ePSXeTerms extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.browser.loadUrl("file:///android_asset/html/privacy.html");
        this.browser.setWebViewClient(new WebViewClient() { // from class: com.epsxe.ePSXe.ePSXeTerms.1
