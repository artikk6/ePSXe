...
class ePSXeViewGLext extends GLSurfaceView implements ePSXeView {
    ...
    static /* synthetic */ int access$3810(ePSXeViewGLext x0) {
        int i = x0.gpuVersionAdvise;
        x0.gpuVersionAdvise = i - 1;
        return i;
    }

    static /* synthetic */ int access$3910(ePSXeViewGLext x0) {
        int i = x0.biosVersionAdvise;
        x0.biosVersionAdvise = i - 1;
        return i;
    }

    static /* synthetic */ int access$4110(ePSXeViewGLext x0) {
        int i = x0.gProfileAdvise;
        x0.gProfileAdvise = i - 1;
        return i;
    }

    public ePSXeViewGLext(Context context, ePSXe act, int ry) {
        super(context);
        this.mfps = 60;
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        redoPads();
        this.f173e.setwh(this.mWidthDraw, this.mHeightDraw, this.emu_screen_ratio);
    }
    ...
    public void stopEmulation(Boolean doQuit) {
        ...
        if (doQuit.booleanValue() && this.quitonexit == 1 && this.f173e != null) {
            this.f173e.quit();
        }
    }
    ...
    public boolean setIsoName(String name, int slot, String gpu) {
        ...
        try {
            ...
            Log.e("epsxe", "unable to load plugin=" + gpu);
            return false;
        }
    }
    ...
    public void setframeskip(int fs) {
        ...
        this.emu_enable_frameskip = this.f173e.setFrameSkip(this.emu_enable_frameskip);
    ...
    public void setscreenorientation(int ori) {
        ...
        this.emu_screen_orientation = this.f173e.setscreenorientation(ori);
    }
    ...
    public void updatescreenratio(int rat) {
        Log.e("epsxeView", "Ratio = " + rat);
        this.emu_screen_ratio = rat;
        this.f173e.updatewh(this.mWidthDraw, this.mHeightDraw, this.emu_screen_ratio);
    }
    ...
    public void setplayermode(int mode) {
        ...
        this.emu_player_mode = this.f173e.setPlayerMode(this.emu_player_mode);
    ...
    public void setsplitmode(int mode) {
        ...
        this.emu_split_mode = this.f173e.setSplitMode(mode);
        this.initvirtualPad = 0;
    }
    ...
    public void setsoundlatency(int mode) {
        ...
        this.emu_sound_latency = this.f173e.setSoundLatency(mode);
    }

    @Override // com.epsxe.ePSXe.ePSXeView
    public void toggletools() {
        this.emu_enable_tools ^= 1;
        this.emu_opengl_options = this.f173e.gpugetoptiongl();
    ...
    public void toggleframelimit() {
        if (this.emu_enable_framelimit == 1) {
            ...
            this.emu_enable_frameskip = this.f173e.setFrameSkip(this.emu_enable_frameskip);
            this.emu_enable_framelimit ^= 1;
            this.emu_enable_framelimit = this.f173e.setFrameLimit(this.emu_enable_framelimit);
            return;
        }
    ...
    public void setinputpadmode(int mode1, int mode2, int analog1, int analog2) {
        if (this.emu_player_mode == 1) {
            ...
            this.f173e.setpadmode(0, mode1);
            this.f173e.setpadmode(1, mode2);
            if (mode1 == 4) {
                this.emu_pad_mode_analog[0] = analog1;
                this.mode = analog1;
                this.f173e.setpadanalogmode(0, this.emu_pad_mode_analog[0]);
            } else if (mode1 == 1) {
            ...
            if (mode2 == 4) {
                ...
                this.f173e.setpadanalogmode(1, this.emu_pad_mode_analog[1]);
            } else if (mode2 == 1) {
    ...
    public void setinputpadmodeanalog(int p) {
        if (this.emu_player_mode == 1) {
            if (this.emu_pad_mode[p] == 4) {
                ...
                iArr[p] = iArr[p] ^ 1;
                this.f173e.setpadanalogmode(p, this.emu_pad_mode_analog[p]);
            }
            if (p == 0) {
    ...
    public void setsnaprestoring(boolean snaprestoring) {
        ...
        this.f173e.loadtmpsnap();
    }

    @Override // com.epsxe.ePSXe.ePSXeView
    public void setautosnaprestoring() {
        Log.e("epsxeView", "loadtmp_snap ");
        this.f173e.loadautosnap();
    }
    ...
    public void exec_tools(int xi, int yi) {
        ...
        if (xi <= (butw * 3) + offx) {
            ...
            if ((val & 56) != 0) {
                this.f173e.gpusetoptiongl(0, 32, 0);
                this.emu_opengl_options &= -57;
                return;
            } else {
                this.f173e.gpusetoptiongl(1, val << 3, 0);
        ...
        if (xi <= (butw * 4) + offx) {
            if ((this.emu_opengl_options & 16384) != 0) {
                this.f173e.gpusetoptiongl(0, 16384, 0);
            } else {
                this.f173e.gpusetoptiongl(1, 16384, 0);
            }
        ...
        if (xi <= (butw * 5) + offx) {
            if ((this.emu_opengl_options & 32768) != 0) {
                this.f173e.gpusetoptiongl(0, 32768, 0);
            } else {
                this.f173e.gpusetoptiongl(1, 32768, 0);
            }
        ...
        if (xi <= (butw * 6) + offx) {
            ...
            if ((this.emu_opengl_options & 448) == 192) {
                this.f173e.gpusetoptiongl(0, InputList.KEYCODE_BUTTON_5, 0);
                this.emu_opengl_options &= -449;
                return;
            } else {
                this.f173e.gpusetoptiongl(1, val2 << 6, 0);
        ...
        if (xi <= (butw * 7) + offx) {
            if ((this.emu_opengl_options & 8192) != 0) {
                this.f173e.gpusetoptiongl(0, 8192, 0);
            } else {
                this.f173e.gpusetoptiongl(1, 8192, 0);
            }
            this.emu_opengl_options ^= 8192;
            return;
        }
        if (xi <= (butw * 8) + offx) {
            this.f173e.gpusaveoptiongl(this.emu_opengl_options);
    ...
    public void toggleStickyButton(int but, int bit) {
        ...
        if (this.stickyButton[but] != 0) {
            this.f173e.setPadDataDown(bit & SupportMenu.USER_MASK, 0);
        } else {
            this.f173e.setPadDataUp(bit & SupportMenu.USER_MASK, 0);
        }
    }
            ...
            if (this.virtualPadId[Id] != -1) {
                ...
                if (but < 20 || this.emu_player_mode != 1 || ext == 0) {
                    if ((this.virtualPadBit[but] & 65536) == 65536) {
                        this.f173e.setPadDataUp(this.virtualPadBit[but] & SupportMenu.USER_MASK, 0);
                        this.statebuttons &= (this.virtualPadBit[but] ^ (-1)) & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataUp(0, this.virtualPadBit[but] & SupportMenu.USER_MASK);
                    }
                }
    ...
    public int touchscreenevent(long eventTime, int action, int x, int y, float pressure, float size, int deviceId, int Id, int pads) {
        ...
        if (action == 1 && this.virtualPadId[Id] != -1) {
            ...
            if (but < 20) {
                ...
                this.f173e.setpadanalog(pad, but - 20, 0, 0);
                if (but == 20) {
        ...
        if (this.emu_pad_mode[this.emu_pad_type_selected] == 4 && mov == 0 && x >= this.virtualPadPos[22][0] && x <= this.virtualPadPos[22][2] && y >= (this.virtualPadPos[22][1] - 140) && y <= (this.virtualPadPos[22][3] + 140)) {
            ...
            this.f173e.setpadanalogmode(this.emu_pad_type_selected, this.emu_pad_mode_analog[this.emu_pad_type_selected]);
            clearAllbuttons(ext);
            init_motionevent_1playerLandscape();
            resetDynamicPad();

            if ((this.virtualPadBit[22] & 65536) == 65536) {
                this.f173e.setPadDataDown(this.virtualPadBit[22] & SupportMenu.USER_MASK, 0);
                this.statebuttons |= this.virtualPadBit[22] & SupportMenu.USER_MASK;
            } else {
                this.f173e.setPadDataDown(0, this.virtualPadBit[22] & SupportMenu.USER_MASK);
            }
            ...
            for (int i2 = 0; i2 < 6; i2++) {
                if (this.padScreenFunc[i2] == 1 && x >= this.virtualPadPos[i2 + 23][0] && x <= this.virtualPadPos[i2 + 23][2] && y >= this.virtualPadPos[i2 + 23][1] && y <= this.virtualPadPos[i2 + 23][3]) {
                    if (this.padScreenExtra[i2] >= 0 && this.padScreenExtra[i2] < 5) {
                        this.f173e.setsslot(this.padScreenExtra[i2]);
                    } else if (this.padScreenExtra[i2] < 10) {
                        this.f173e.setsslot(this.padScreenExtra[i2] + 5);
            ...
            if (x >= this.virtualPadPos[ind][0] && x <= this.virtualPadPos[ind][2] && y >= this.virtualPadPos[ind][1] && y <= this.virtualPadPos[ind][3] && action == 0) {
                ...
                if (this.virtualPadId[Id] != -1) {
                    ...
                    if (ind2 < 20 || this.emu_player_mode != 1) {
                        if ((this.virtualPadBit[ind2] & 65536) == 65536) {
                            this.f173e.setPadDataUp(this.virtualPadBit[ind2] & SupportMenu.USER_MASK, 0);
                            this.statebuttons &= (this.virtualPadBit[ind2] ^ (-1)) & SupportMenu.USER_MASK;
                        } else {
                            this.f173e.setPadDataUp(0, this.virtualPadBit[ind2] & SupportMenu.USER_MASK);
                        }
                    } else if (ind2 < 22 && ext != 0) {
                        int pad2 = ((this.virtualPadBit[ind2] >> 16) & 1) ^ 1;
                        this.f173e.setpadanalog(pad2, ind2 - 20, 0, 0);
                        if (ind2 == 20) {
                ...
                if (ind < 20 || this.emu_player_mode != 1) {
                    if ((this.virtualPadBit[ind] & 65536) == 65536) {
                        this.f173e.setPadDataDown(this.virtualPadBit[ind] & SupportMenu.USER_MASK, 0);
                        this.statebuttons |= this.virtualPadBit[ind] & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataDown(0, this.virtualPadBit[ind] & SupportMenu.USER_MASK);
                    }
                    ...
                    this.f173e.setpadanalog(pad3, ind - 20, xa2 - 128, ya2 - 128);
        ...
        if (this.emu_pad_dynamic == 1 && this.virtualPadId[Id] == -1) {
            if (x >= this.mWidth / 2 || this.emu_pad_mode[this.emu_pad_type_selected] != 4 || this.emu_pad_mode_analog[this.emu_pad_type_selected] != 1) {
                ...
                this.analog_values[0][0] = x;
                this.analog_values[0][1] = this.mHeight - y;
                this.f173e.setpadanalog(pad4, 0, -128, -128);
            ...
            if (x >= x1 && x <= x2 && y >= y1 && y <= y2) {
                ...
                if (seg > 0 && seg < 17) {
                    ...
                    if ((this.virtualPadBit[ind22] & 65536) == 65536) {
                        this.f173e.setPadDataDown(this.virtualPadBit[ind22] & SupportMenu.USER_MASK, 0);
                        this.statebuttons |= this.virtualPadBit[ind22] & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataDown(0, this.virtualPadBit[ind22] & SupportMenu.USER_MASK);
                    }
        ...
        if (this.emu_pad_mode[this.emu_pad_type_selected] == 4 || this.emu_pad_mode[this.emu_pad_type_selected] == 1) {
            if (found == 0 && this.emu_pad_mode[this.emu_pad_type_selected] == 4 && this.emu_pad_mode_analog[this.emu_pad_type_selected] == 1 && (this.virtualPadId[Id] == 20 || this.virtualPadId[Id] == 21)) {
                ...
                this.f173e.setpadanalog(pad5, ind23 - 20, xa - 128, ya - 128);
            }
            if (this.emu_pad_dynamic == 1 && found == 0 && this.virtualPadId[Id] > 11 && this.virtualPadId[Id] < 20 && (this.emu_pad_mode[this.emu_pad_type_selected] == 1 || (this.emu_pad_mode[this.emu_pad_type_selected] == 4 && this.emu_pad_mode_analog[this.emu_pad_type_selected] == 0))) {
                ...
                if (siz >= ((int) ((this.padSizeScreenLan[this.mode][0] * this.padScreenResize[this.mode][0]) / 12.0f)) && seg2 > 0 && seg2 < 17) {
                    ...
                    if ((this.virtualPadBit[up] & 65536) == 65536) {
                        this.f173e.setPadDataUp(this.virtualPadBit[up] & SupportMenu.USER_MASK, 0);
                        this.statebuttons &= (this.virtualPadBit[up] ^ (-1)) & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataUp(0, this.virtualPadBit[up] & SupportMenu.USER_MASK);
                    }
                    if ((this.virtualPadBit[ind24] & 65536) == 65536) {
                        this.f173e.setPadDataDown(this.virtualPadBit[ind24] & SupportMenu.USER_MASK, 0);
                        this.statebuttons |= this.virtualPadBit[ind24] & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataDown(0, this.virtualPadBit[ind24] & SupportMenu.USER_MASK);
                    }
            ...
            if (this.emu_action_dynamic == 1 && found == 0 && this.virtualPadId[Id] > 3 && this.virtualPadId[Id] < 8) {
                ...
                if (siz2 >= ((int) ((this.padSizeScreenLan[this.mode][2] * this.padScreenResize[this.mode][1]) / 12.0f)) && seg3 > 0 && seg3 < 17) {
                    ...
                    if ((this.virtualPadBit[up2] & 65536) == 65536) {
                        this.f173e.setPadDataUp(this.virtualPadBit[up2] & SupportMenu.USER_MASK, 0);
                        this.statebuttons &= (this.virtualPadBit[up2] ^ (-1)) & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataUp(0, this.virtualPadBit[up2] & SupportMenu.USER_MASK);
                    }
                    if ((this.virtualPadBit[ind25] & 65536) == 65536) {
                        this.f173e.setPadDataDown(this.virtualPadBit[ind25] & SupportMenu.USER_MASK, 0);
                        this.statebuttons |= this.virtualPadBit[ind25] & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataDown(0, this.virtualPadBit[ind25] & SupportMenu.USER_MASK);
                    }
            ...
            if (this.virtualPadId[Id] == -1 && found == 0 && this.emu_action_dynamic == 0 && this.emu_pad_dynamic == 0) {
                ...
                if (selected != -1) {
                    if ((this.virtualPadBit[selected] & 65536) == 65536) {
                        this.f173e.setPadDataDown(this.virtualPadBit[selected] & SupportMenu.USER_MASK, 0);
                        this.statebuttons |= this.virtualPadBit[selected] & SupportMenu.USER_MASK;
                    } else {
                        this.f173e.setPadDataDown(0, this.virtualPadBit[selected] & SupportMenu.USER_MASK);
                    }
        ...
        if (this.emu_pad_type[0] != 1 || this.emu_pad_type[1] != 1 || this.emu_enable_tools != 0) {
            if (actionCode == 5 || actionCode == 6 || actionCode == 1 || actionCode == 0 || actionCode == 2) {
                if (this.emu_pad_mode[0] == 3 || this.emu_pad_mode[0] == 8) {
                    vib = this.gun.touchscreeneventgun(0L, action, x, y, 0.0f, 0.0f, 0, pointerId, this.f173e, this.emu_pad_mode[0], this.mfps, this.mWidth, this.mHeight, this.emu_pad_type_selected);
    ...
    private void queueMotionEvent(MotionEvent event) {
        ...
        if (this.emu_pad_type[0] != 1 || this.emu_pad_type[1] != 1) {
            if (actionCode == 5 || actionCode == 6 || actionCode == 1 || actionCode == 0) {
                if (this.emu_pad_mode[0] == 3 || this.emu_pad_mode[0] == 8) {
                    vib = this.gun.touchscreeneventgun(event.getEventTime(), event.getAction(), (int) event.getX(i), (int) event.getY(i), event.getPressure(i), event.getSize(i), event.getDeviceId(), event.getPointerId(i), this.f173e, this.emu_pad_mode[0], this.mfps, this.mWidth, this.mHeight, this.emu_pad_type_selected);
    ...
    public void setSaveMode(int mode, int auto) {
        ...
        this.f173e.setSaveMode(mode, auto);
        super.onPause();
    }
    ...
    public void onPause(int mode, int auto) {
        try {
            ...
            if (this.f173e != null) {
                this.f173e.setPauseMode(mode, auto);
            }
            super.onPause();
        } catch (Exception e) {
        }
    ...
    private class EmuGLThread extends Thread {
        ...
        public void saveGLState(GL10 gl) {
            this.csvertex = ((GL11) gl).glIsEnabled(32884);
            this.cscolor = ((GL11) gl).glIsEnabled(32886);
            this.cstexture = ((GL11) gl).glIsEnabled(32888);
            this.csnormal = ((GL11) gl).glIsEnabled(32885);
            this.mtex2d = ((GL11) gl).glIsEnabled(3553);
            this.mblend = ((GL11) gl).glIsEnabled(3042);
            this.msci = ((GL11) gl).glIsEnabled(3089);
            this.csat = ((GL11) gl).glIsEnabled(3008);
            this.floatBuffer.rewind();
            gl.glDisable(3008);
            gl.glGetIntegerv(2978, this.viewport, 0);
            gl.glGetIntegerv(32873, this.intVar, 0);
            gl.glGetIntegerv(3041, this.intVar, 1);
            gl.glGetIntegerv(3040, this.intVar, 2);
            ((GL11) gl).glGetTexParameteriv(3553, 10241, this.intVar, 3);
            ((GL11) gl).glGetTexParameteriv(3553, 10240, this.intVar, 4);
            ((GL11) gl).glGetTexParameteriv(3553, 10242, this.intVar, 5);
            ((GL11) gl).glGetTexParameteriv(3553, 10243, this.intVar, 6);
            ((GL11) gl).glGetFloatv(2816, this.floatBuffer);
            gl.glPushMatrix();
            gl.glViewport(0, 0, ePSXeViewGLext.this.mWidth, ePSXeViewGLext.this.mHeight);
            gl.glMatrixMode(5889);
            gl.glLoadIdentity();
            gl.glOrthof(0.0f, ePSXeViewGLext.this.mWidth, 0.0f, ePSXeViewGLext.this.mHeight, 1.0f, -1.0f);
            gl.glDisableClientState(32886);
            gl.glDisable(3089);
        }

        public void restoreGLState(GL10 gl) {
            if (this.mblend) {
                gl.glEnable(3042);
            } else {
                gl.glDisable(3042);
            ...
            gl.glBindTexture(3553, this.intVar[0]);
            gl.glBlendFunc(this.intVar[1], this.intVar[2]);
            ((GL11) gl).glTexParameteri(3553, 10241, this.intVar[3]);
            ((GL11) gl).glTexParameteri(3553, 10240, this.intVar[4]);
            ((GL11) gl).glTexParameteri(3553, 10242, this.intVar[5]);
            ((GL11) gl).glTexParameteri(3553, 10243, this.intVar[6]);
            gl.glColor4f(this.floatBuffer.get(0), this.floatBuffer.get(1), this.floatBuffer.get(2), this.floatBuffer.get(3));
            gl.glViewport(this.viewport[0], this.viewport[1], this.viewport[2], this.viewport[3]);
            gl.glPopMatrix();
        }

        public void drawFPS(GL10 gl) {
            int value = ePSXeViewGLext.this.f173e.gpugetoptionfixesgl() & 32767;
            String vs = ePSXeViewGLext.this.emu_enable_tools == 1 ? String.format(" 0x%04x", Integer.valueOf(value)) : "";
            gl.glDisable(3089);
            gl.glEnable(3553);
            gl.glEnable(3042);
            ...
            if (ePSXeViewGLext.this.tainted == 1) {
                this.glText.draw(String.valueOf(ePSXeViewGLext.this.f173e.getFPS()) + "/" + ePSXeViewGLext.this.mfps + "*" + vs, ePSXeViewGLext.this.overscan_x + 0, ((ePSXeViewGLext.this.mHeight * ePSXeViewGLext.this.screenResize) - this.glText.getCharHeight()) - ePSXeViewGLext.this.overscan_y);
            } else {
                this.glText.draw(String.valueOf(ePSXeViewGLext.this.f173e.getFPS()) + "/" + ePSXeViewGLext.this.mfps + vs, ePSXeViewGLext.this.overscan_x + 0, ((ePSXeViewGLext.this.mHeight * ePSXeViewGLext.this.screenResize) - this.glText.getCharHeight()) - ePSXeViewGLext.this.overscan_y);
            }
            this.glText.end();
        ...
        public void drawGPUOutdated(GL10 gl) {
            gl.glDisable(3089);
            gl.glEnable(3553);
            gl.glEnable(3042);
            gl.glBlendFunc(770, 771);
            this.glText.begin(1.0f, 1.0f, 1.0f, 1.0f);
            this.glText.draw("OpenGL Plugin outdated, get a new copy from google play", 60.0f, this.glText.getCharHeight());
            this.glText.end();
            gl.glDisable(3042);
            gl.glDisable(3553);
        }
            ...
            try {
                if (ePSXeViewGLext.this.emu_player_mode != 1 || ePSXeViewGLext.this.emu_pad_draw_mode[0] == 2 || ePSXeViewGLext.this.emu_pad_mode[0] == 3 || ePSXeViewGLext.this.emu_pad_mode[0] == 8) {
                    if (ePSXeViewGLext.this.emu_pad_mode[0] == 3 || ePSXeViewGLext.this.emu_pad_mode[0] == 8) {
                        ePSXeViewGLext.this.gun.drawGunGlExt(gl, this.mTexLan, this.textureRgnLan, this.batchLan, ePSXeViewGLext.this.mWidth, ePSXeViewGLext.this.mHeight, ePSXeViewGLext.this.emu_input_alpha, ePSXeViewGLext.this.screenResize);
                        return;
                    }
                    return;
                }
                    ...
                    if (ePSXeViewGLext.this.padScreenExtraEnabled == 1) {
                        ...
                        for (int i = 14; i < 20; i++) {
                            if ((ePSXeViewGLext.this.padScreenStatus[ePSXeViewGLext.this.mode][i] & 2) != 2) {
                                if (ePSXeViewGLext.this.padScreenExtra[i - 14] >= 20 && ePSXeViewGLext.this.stickyButton[ePSXeViewGLext.this.padScreenExtra[i - 14] - 20] == 1) {
                                    int j = ePSXeViewGLext.this.padScreenExtra[i - 14];
                                    this.batchLan[i].beginBatch();
                                    this.batchLan[i].drawSprite(ePSXeViewGLext.this.padOffScreenPor[(i * 2) + 0], ePSXeViewGLext.this.padOffScreenPor[(i * 2) + 1], ePSXeViewGLext.this.padSizeScreenPor[(i * 2) + 0], ePSXeViewGLext.this.padSizeScreenPor[(i * 2) + 1], this.textureRgnLan[j]);
                                    this.batchLan[i].endBatch();
                                } else {
                                    this.batchLan[i].beginBatch();
                                    this.batchLan[i].drawSprite(ePSXeViewGLext.this.padOffScreenPor[(i * 2) + 0], ePSXeViewGLext.this.padOffScreenPor[(i * 2) + 1], ePSXeViewGLext.this.padSizeScreenPor[(i * 2) + 0], ePSXeViewGLext.this.padSizeScreenPor[(i * 2) + 1], this.textureRgnLan[i]);
                                    this.batchLan[i].endBatch();
                                }
                            }
                        }
                ...
                gl.glBlendFunc(770, 771);
                gl.glColor4f(1.0f, 1.0f, 1.0f, ePSXeViewGLext.this.emu_input_alpha);
                if (ePSXeViewGLext.this.emu_pad_mode[ePSXeViewGLext.this.emu_pad_type_selected] == 4) {
                    if (ePSXeViewGLext.this.emu_pad_mode_analog[ePSXeViewGLext.this.emu_pad_type_selected] == 0) {
                        st = 0;
                        en = 9;
                    } else {
                        st = 0;
                ...
                if (!ePSXeViewGLext.this.hidePad) {
                ...
                for (int i2 = st; i2 < en; i2++) {
                    if (ePSXeViewGLext.this.padScreenStatus[ePSXeViewGLext.this.mode][i2] == 1) {
                        if (i2 > 1) {
                            if (i2 < 11 && i2 != 8) {
                                if ((ePSXeViewGLext.this.statebuttons & ePSXeViewGLext.this.psxbuttonval[i2]) != 0) {
                                    this.batchLan[i2].beginBatch();
                                    this.batchLan[i2].drawSprite(ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.glresizeX, ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.glresizeY, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.buttonMag * ePSXeViewGLext.this.glresizeX, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.buttonMag * ePSXeViewGLext.this.glresizeY, this.textureRgnLan[i2]);
                                    this.batchLan[i2].endBatch();
                                } else {
                                    this.batchLan[i2].beginBatch();
                                    this.batchLan[i2].drawSprite(ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.glresizeX, ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.glresizeY, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.glresizeX, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.glresizeY, this.textureRgnLan[i2]);
                                    this.batchLan[i2].endBatch();
                                }
                            } else {
                                this.batchLan[i2].beginBatch();
                            ...
                            if (ePSXeViewGLext.this.dpadskin == 1) {
                                float sx = ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.glresizeX;
                                float sy = ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.glresizeY;
                                float ox = (ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.glresizeX) - (sx / 2.0f);
                                float oy = (ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.glresizeY) - (sy / 2.0f);
                                for (int p = 0; p < 4; p++) {
                                    if ((ePSXeViewGLext.this.statebuttons & (4096 << p)) == 0) {
                                        if (ePSXeViewGLext.this.emu_pad_draw_mode[0] != 4) {
                                            this.batchLanDpad[p].beginBatch();
                                            this.batchLanDpad[p].drawSprite((this.offDpadX[p] * sx) + ox, (this.offDpadY[p] * sy) + oy, this.sizeDpadX[p] * sx, this.sizeDpadY[p] * sy, this.textureRgnLanDpad[p]);
                                            this.batchLanDpad[p].endBatch();
                                        }
                                    } else {
                                        this.batchLanDpad[p].beginBatch();
                                        this.batchLanDpad[p].drawSprite((this.offDpadX[p] * sx) + ox, (this.offDpadY[p] * sy) + oy, this.sizeDpadX[p] * sx * ePSXeViewGLext.this.buttonMag, this.sizeDpadY[p] * sy * ePSXeViewGLext.this.buttonMag, this.textureRgnLanDpad[p]);
                                        this.batchLanDpad[p].endBatch();
                                    }
                                }
                            } else {
                            ...
                            float sx2 = ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.glresizeX;
                            float sy2 = ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * ePSXeViewGLext.this.glresizeY;
                            float ox2 = (ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 0] * ePSXeViewGLext.this.glresizeX) - (sx2 / 2.0f);
                            float oy2 = (ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i2 * 2) + 1] * ePSXeViewGLext.this.glresizeY) - (sy2 / 2.0f);
                            for (int p2 = 0; p2 < 4; p2++) {
                                if ((ePSXeViewGLext.this.statebuttons & (16 << p2)) == 0) {
                                    if (ePSXeViewGLext.this.emu_pad_draw_mode[0] != 4) {
                                    ...
                                    this.batchLanAction[p2].beginBatch();
                                    this.batchLanAction[p2].drawSprite((this.offActionX[p2] * sx2) + ox2, (this.offActionY[p2] * sy2) + oy2, this.sizeActionX[p2] * sx2 * ePSXeViewGLext.this.buttonMag, this.sizeActionY[p2] * sy2 * ePSXeViewGLext.this.buttonMag, this.textureRgnLanAction[p2]);
                                    this.batchLanAction[p2].endBatch();
                                }
                            }
                        }
                        if (i2 == 11 || i2 == 12) {
                            this.batchLan[i2].beginBatch();
                            this.batchLan[i2].drawSprite(ePSXeViewGLext.this.analog_values[0][(i2 - 11) * 2] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.analog_values[0][((i2 - 11) * 2) + 1] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][26] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * 2.0f * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][27] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i2] * 2.0f * ePSXeViewGLext.this.screenResize, this.textureRgnLan[13]);
                            this.batchLan[i2].endBatch();
                        }
                    }
                }
                if (ePSXeViewGLext.this.padScreenExtraEnabled == 1) {
                    ...
                    for (int i3 = 14; i3 < 20; i3++) {
                        if (ePSXeViewGLext.this.padScreenStatus[ePSXeViewGLext.this.mode][i3] == 1) {
                            if (ePSXeViewGLext.this.padScreenExtra[i3 - 14] >= 20 && ePSXeViewGLext.this.stickyButton[ePSXeViewGLext.this.padScreenExtra[i3 - 14] - 20] == 1) {
                                int j2 = ePSXeViewGLext.this.padScreenExtra[i3 - 14];
                                this.batchLan[i3].beginBatch();
                                this.batchLan[i3].drawSprite(ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 0] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 1] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 0] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i3] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 1] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i3] * ePSXeViewGLext.this.screenResize, this.textureRgnLan[j2]);
                                this.batchLan[i3].endBatch();
                            } else {
                                this.batchLan[i3].beginBatch();
                                this.batchLan[i3].drawSprite(ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 0] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padOffScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 1] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 0] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i3] * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padSizeScreenLan[ePSXeViewGLext.this.mode][(i3 * 2) + 1] * ePSXeViewGLext.this.padScreenResize[ePSXeViewGLext.this.mode][i3] * ePSXeViewGLext.this.screenResize, this.textureRgnLan[i3]);
                                this.batchLan[i3].endBatch();
                            }
                        }
                    }
        ...
        public void drawTools(GL10 gl) {
            ...
            this.batchTools.drawSprite((ePSXeViewGLext.this.mWidth / 2f) * ePSXeViewGLext.this.screenResize, (ePSXeViewGLext.this.mHeight - ((ePSXeViewGLext.this.padResize * 60.0f) / 2.0f)) * ePSXeViewGLext.this.screenResize, 508.0f * ePSXeViewGLext.this.padResize * ePSXeViewGLext.this.screenResize, ePSXeViewGLext.this.padResize * 60.0f * ePSXeViewGLext.this.screenResize, this.textureRgnTools);
        ...
        public void drawSelected(GL10 gl, int v, int c) {
            if (c == 1) {
            ...
            float ox = (((ePSXeViewGLext.this.mWidth - (508.0f * ePSXeViewGLext.this.padResize)) / 2.0f) + (((508.0f * ePSXeViewGLext.this.padResize) / 9.0f) * v)) * ePSXeViewGLext.this.screenResize;
            float oy = (ePSXeViewGLext.this.mHeight - (60.0f * ePSXeViewGLext.this.padResize)) * ePSXeViewGLext.this.screenResize;
            float sw = ((508.0f * ePSXeViewGLext.this.padResize) / 9.0f) * ePSXeViewGLext.this.screenResize;
            float sh = 60.0f * ePSXeViewGLext.this.padResize * ePSXeViewGLext.this.screenResize;
        ...
        public void drawSelectedTools(GL10 gl) {
            int value = ePSXeViewGLext.this.emu_opengl_options;
            if ((value & 7) != 0) {
                drawSelected(gl, 1, value & 7);
            }
            if ((value & 56) != 0) {
                drawSelected(gl, 2, (value >> 3) & 7);
            }
            if ((value & 448) != 0) {
                drawSelected(gl, 5, (value >> 6) & 3);
            }
            if ((32768 & value) != 0) {
                drawSelected(gl, 4, 1);
            }
        ...
        void saveImageRaw(short[] sb) {
            String root = ContextCompat.getDataDir(getContext()).toString();
            File myDir = new File(root + "/epsxe/sstates/");
            String fname = ePSXeViewGLext.this.f173e.getCode() + ".00" + (ePSXeViewGLext.this.screenshot - 10) + ".pic";
            if (ePSXeViewGLext.this.biosmsg) {
                fname = ePSXeViewGLext.this.f173e.getCode() + "HLE.00" + (ePSXeViewGLext.this.screenshot - 10) + ".pic";
            }
        ...
        public void doMiniPic(GL10 gl) {
            int lwidth = ePSXeViewGLext.this.mWidth;
            int lheight = ePSXeViewGLext.this.mHeight;
            if (ePSXeViewGLext.this.emu_screen_orientation == 1) {
                lheight = ePSXeViewGLext.this.mHeight / 2;
            }
            int screenshotSize = lwidth * lheight;
            ByteBuffer bb = ByteBuffer.allocateDirect(screenshotSize * 4);
            bb.order(ByteOrder.nativeOrder());
            if (ePSXeViewGLext.this.emu_screen_orientation == 1) {
                gl.glReadPixels(0, lheight, lwidth, lheight, 6408, 5121, bb);
            } else {
                gl.glReadPixels(0, 0, lwidth, lheight, 6408, 5121, bb);
            }
        ...
        public void FlipGL() {
            if (ePSXeViewGLext.this.emu_enable_framelimit == 1 || this.flimit > 7) {
                ...
                if (ePSXeViewGLext.this.emu_gpu_mt_mode > 0 && ePSXeViewGLext.this.gpuVersion == -1) {
                    ePSXeViewGLext.this.gpuVersion = ePSXeViewGLext.this.f173e.getGPUVersion();
                }
                if (ePSXeViewGLext.this.gpuVersion < 16 && ePSXeViewGLext.this.gpuVersion >= 0) {
                    ...
                    if (ePSXeViewGLext.this.gpuVersionAdvise > 0) {
                        ePSXeViewGLext.access$3810(ePSXeViewGLext.this);
                    } else {
                        ePSXeViewGLext.this.gpuVersion = 16;
                    }
                }
                if (!ePSXeViewGLext.this.biosmsg || ePSXeViewGLext.this.biosVersionAdvise <= 0) {
                    if (ePSXeViewGLext.this.gprofile && ePSXeViewGLext.this.gProfileAdvise > 0) {
                        if (ePSXeViewGLext.this.emu_verbose == 1) {
                    ...
                    ePSXeViewGLext.access$3910(ePSXeViewGLext.this);
                }
        ...
        public void run() {
            initEGL();
            initGL();
            ePSXeViewGLext.this.f173e.setwh(ePSXeViewGLext.this.mWidthDraw, ePSXeViewGLext.this.mHeightDraw, ePSXeViewGLext.this.emu_screen_ratio);
            ePSXeViewGLext.this.mfps = ePSXeViewGLext.this.f173e.loadepsxe(ePSXeViewGLext.this.mIsoName, ePSXeViewGLext.this.mIsoSlot);
            ...
            if (ePSXeViewGLext.this.emu_gpu_mt_mode > 0) {
                ...
                ePSXeViewGLext.this.mGLRunThread.setePSXeLib(ePSXeViewGLext.this.f173e);
                ePSXeViewGLext.this.mGLRunThread.start();
                ePSXeViewGLext.this.f173e.runwrapper(0);
                ePSXeViewGLext.this.mGLRunThread.exit();
            } else {
                ePSXeViewGLext.this.gpuVersion = ePSXeViewGLext.this.f173e.getGPUVersion();
                while (!this.mDone) {
                    ePSXeViewGLext.this.f173e.runemulatorframeGLext();
                }
                ePSXeViewGLext.this.f173e.runemulatorframeGLext();
                ePSXeViewGLext.this.f173e.runemulatorframeGLext();
                ePSXeViewGLext.this.f173e.runemulatorframeGLext();
        ...
        public void loadExtraButtonsTextures() {
            ...
            this.wTextmp = 512;
            for (int i = 0; i < 6; i++) {
                int j = ePSXeViewGLext.this.padScreenExtra[i];
                if (j >= 0) {
                    if (j >= 24) {
                        j += 4;
                    }
                    ...
                    this.batchLan[i + 14] = new SpriteBatch(this.mGL, 1);
                }
            }
        }
        ...
        public void initGL() {
            ...
            float aspect = (float)ePSXeViewGLext.this.mWidth / ePSXeViewGLext.this.mHeight;
            GLU.gluPerspective(this.mGL, 45.0f, aspect, 1.0f, 30.0f);
            ...
            if (ePSXeViewGLext.this.emu_player_mode != 1 || ePSXeViewGLext.this.emu_screen_orientation != 1 || ePSXeViewGLext.this.emu_portrait_skin != 0) {
                if (ePSXeViewGLext.this.emu_pad_mode[0] != 3) {
                    if (ePSXeViewGLext.this.emu_pad_mode[0] == 8) {
                        ...
                        if (ePSXeViewGLext.this.emu_pad_draw_mode[0] == 4) {
                            File f = new File(ePSXeViewGLext.this.skinName);
                            if (f.exists()) {
                        ...
                        for (int i3 = 0; i3 < 4; i3++) {
                            ...
                            this.batchLanAction[i3] = new SpriteBatch(this.mGL, 1);
                        ...
                        for (int i4 = 0; i4 < 4; i4++) {
                            ...
                            this.batchLanDpad[i4] = new SpriteBatch(this.mGL, 1);
                        ...
                        for (int i5 = 0; i5 < 4; i5++) {
                            ...
                            this.batchLan[i5 + 20] = new SpriteBatch(this.mGL, 1);
                        }
                        for (int i6 = 0; i6 < 4; i6++) {
                            ...
                            this.batchLan[i6 + 24] = new SpriteBatch(this.mGL, 1);
                        }
                    }
                } else {
                    int[] padCoords3 = {
                    ...
                    for (int i7 = 0; i7 < 2; i7++) {
                        ...
                        this.batchLan[i7] = new SpriteBatch(this.mGL, 1);
                    }
                }
            } else {
                ...
                for (int i8 = 0; i8 < 4; i8++) {
                    ...
                    this.batchLan[i8 + 20] = new SpriteBatch(this.mGL, 1);
                }
                for (int i9 = 0; i9 < 4; i9++) {
                    ...
                    this.batchLan[i9 + 24] = new SpriteBatch(this.mGL, 1);
                }
            }
        ...
        private void checkEglError() {
            ...
            if (error != 12288) {
                Log.w("epsxe", "EGL error = 0x" + Integer.toHexString(error));
            }
        }
        ...
        public void initEGL() {
            ...
            if (this.mEglSurface == null || this.mEglSurface == EGL10.EGL_NO_SURFACE) {
                ...
                Log.e("epsxe", "createWindowSurface returned " + error);
                if (error == 12299) {
                    Log.e("epsxe", "createWindowSurface returned EGL_BAD_NATIVE_WINDOW.");
                    return;
                } else {
                    Log.e("epsxe", "createWindowSurface failed " + error);
                    return;
                }
            }
    ...
    private class ePSXeWrapperThread extends Thread {
        ...
        public void run() {
            while (!this.tDone.booleanValue()) {
                this.f175e.runemulatorframeGLext();
            }
        }
